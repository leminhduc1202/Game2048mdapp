...
import com.mdapp.game2048mdapp.databinding.ActivityMainBinding
import com.mdapp.game2048mdapp.databinding.CellBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun changeCellBackground(cellBinding: CellBinding?, score: Int) {
        when (score) {
            ...
            else -> cellBinding?.cellBackground?.setBackgroundColor(Color.parseColor("#F7971D"))
        }
    }
